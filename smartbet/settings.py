...
SECRET_KEY = 'django-insecure-^n-%7gq2z*i41-j(nxd93l$2y%p(fj@o%x0ugwk@-+r_75lsr4'
...
INSTALLED_APPS = [
    ...
    'core',
    'fixtures',
    # 'django_q',  # Removed because package is not installed
]
...
# Django-Q configuration - Commented out since we're not using django_q
# Q_CLUSTER = {
#     'name': 'smartbet',
#     'workers': 4,
#     'recycle': 500,
