...
Fixes the string/integer goal conversion issue
"""
...
class FixedDataCollector:
    def __init__(self):
        ...
        self.leagues = {
            'bundesliga': {
                ...
                'name': 'Bundesliga',
                'country': 'Germany',
                'target_seasons': ['2022/2023', '2023/2024', '2021/2022']
            },
            'ligue1': {
                'league_id': 301,
                'name': 'Ligue 1',
    ...
    def extract_fixture_features(self, fixture, league_name):
        """Extract features from a fixture with proper data type handling."""
        try:
            ...
            # Extract goals with SAFE conversion
            goals_data = final_score.get('score', {})
            home_goals = self.safe_int_conversion(goals_data.get('participant'))
            away_goals = self.safe_int_conversion(goals_data.get('goals'))
            
            # Determine outcome (1X2) - NOW with proper integer comparison
    ...
    def collect_all_data(self):
        ...
        self.log("🚀 STARTING FIXED BUNDESLIGA AND LIGUE 1 DATA COLLECTION")
        self.log("=" * 70)
