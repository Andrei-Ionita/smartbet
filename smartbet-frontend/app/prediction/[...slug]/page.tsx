...
export default async function PredictionPage({ params }: PageProps) {
    ...
    const recommendation: Recommendation = {
        ...
        odds: fixture.best_market?.odds ||
            (fixture.predicted_outcome === 'Home' ? fixture.odds_data?.home :
                fixture.predicted_outcome === 'Draw' ? fixture.odds_data?.draw :
                    fixture.odds_data?.away) || null,
        ev: fixture.best_market?.expected_value || fixture.ev_analysis?.best_ev || null,
        score: fixture.market_indicators?.market_score || 0, // Fallback
        explanation: `AI prediction for ${fixture.home_team} vs ${fixture.away_team} favoring ${fixture.predicted_outcome}.`
    }
