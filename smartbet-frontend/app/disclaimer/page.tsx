    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
                ...
                <p className="text-gray-600">Please read this disclaimer carefully before using BetGlitch</p>
            </div>
            ...
            <div className="bg-red-50 border-2 border-red-200 rounded-xl p-6 mb-8">
                <div className="flex gap-4">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-red-800 mb-3">BetGlitch is NOT a Betting Operator</h2>
                        <p className="text-red-700 mb-4">
                            BetGlitch does NOT accept bets, wagers, deposits, or any form of payment for gambling purposes.
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 space-y-8">
                ...
                <section>
                    ...
                    <p className="text-gray-600">
                        By using BetGlitch, you confirm that you meet the minimum age requirement and are
                ...
                <section>
                    ...
                    <p className="text-gray-600 mb-4">
                        BetGlitch does not target any specific jurisdiction and makes no representations
                    ...
                    <p className="text-gray-600">
                        ...
                        prohibited, you should not use this website. BetGlitch is not responsible for any
                ...
                <section>
                    ...
                    <p className="text-gray-600 mb-4">
                        To the maximum extent permitted by applicable law, BetGlitch and its affiliates,
                ...
                <section>
                    ...
                    <p className="text-gray-600">
                        ...
                        third-party sites. The inclusion of any link does not imply endorsement by BetGlitch.
                    </p>
                </section>
