...
const COPY = {
  en: {
    title: 'Privacy Policy', updated: 'Last updated: August 19, 2026', home: 'Return to Home',
    ...
    data: ['Current beta: public research can be used without an account, payment or submitted email address.', 'Dormant earlier-test records: account details, password hashes, bankroll entries and newsletter preferences may remain until deletion is requested.', 'Security and delivery: IP address, request time, browser information and short-lived rate-limit identifiers may enter infrastructure logs.', 'Support: the content and contact details in a message you send us.'],
  ...
  ro: {
    title: 'Politica de confidențialitate', updated: 'Ultima actualizare: 19 august 2026', home: 'Înapoi la pagina principală',
    ...
    storageTitle: '5. Stocarea în browser', storage: 'BetGlitch folosește stocarea locală pentru confirmarea vârstei și alegerea limbii. Modul fără cont elimină datele vechi de autentificare, cont și buget din etapa beta anterioară. Nu este instalată nicio rețea de cookie-uri publicitare.',
