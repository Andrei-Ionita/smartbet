...
const CAPTURE_COPY = {
    en: {
        eyebrow: 'Published-pick and result updates',
        heroTitle: 'Follow published picks by email',
        heroDescription:
    ...
    ro: {
        eyebrow: 'Actualizări despre selecții publicate și rezultate',
        heroTitle: 'Urmărește selecțiile publicate pe email',
        heroDescription:
            'Un email săptămânal despre selecțiile publicate de BetGlitch și cum s-au încheiat. Și câștiguri, și pierderi.',
        defaultTitle: 'Primește rezumatul săptămânal',
        defaultDescription: 'Un rezumat săptămânal al selecțiilor publicate și al rezultatelor lor.',
        cta: 'Abonează-te',
