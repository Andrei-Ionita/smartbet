...
const COPY = {
  en: {
    back: 'All strategies', hypothesis: 'Strategy hypothesis', mechanics: 'How it works', useful: 'When the idea may be useful', risks: 'Where it can fail', settlement: 'Settlement', example: 'Worked example', breakEven: 'Price check', evidence: 'Current lab evidence', evidenceBody: 'This counter shows validation activity for this exact strategy version. Public performance history is paused until the selection engine rules are locked.', boundaryTitle: 'What this page is—and is not', boundaryBody: 'This page explains a market hypothesis and may show current research candidates. A selection is not a promise of profit, personalized advice or proof that the strategy works.', inspect: 'Inspect live fixtures', methodology: 'Read the testing methodology', results: 'Open Strategy Results', related: 'Continue learning',
  },
  ro: {
    back: 'Toate strategiile', hypothesis: 'Ipoteza strategiei', mechanics: 'Cum funcționează', useful: 'Când poate fi utilă ideea', risks: 'Unde poate eșua', settlement: 'Decontare', example: 'Exemplu explicat', breakEven: 'Verificarea prețului', evidence: 'Dovezi curente din laborator', evidenceBody: 'Contorul arată activitatea de validare pentru această versiune exactă. Istoricul public este suspendat până când regulile motorului de selecție sunt blocate.', boundaryTitle: 'Ce este și ce nu este această pagină', boundaryBody: 'Pagina explică o ipoteză de piață și poate afișa candidați actuali pentru cercetare. O selecție nu este o promisiune de profit, un sfat personalizat sau dovada că strategia funcționează.', inspect: 'Analizează meciurile curente', methodology: 'Citește metodologia de testare', results: 'Deschide Rezultatele Strategiilor', related: 'Continuă să înveți',
  },
}
