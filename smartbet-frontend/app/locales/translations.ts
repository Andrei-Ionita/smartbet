    ...
    en: {
        ...
        trackRecord: {
            ...
            filters: {
                ...
                verifiedSettled: 'Verified-price rows — settled',
                verifiedAll: 'Verified-price rows — including pending',
                legacyArchive: 'Legacy archive',
                showing: 'Showing {0} rows',
                dateFrom: 'From',
                dateTo: 'To',
    ...
    ro: {
        ...
        trackRecord: {
            ...
            stats: {
                ...
                marketDoubleChance: 'Șansă dublă'
            },
            filters: {
                label: 'Filtre:',
                allLeagues: 'Toate Ligile',
                recordView: 'Vizualizare istoric',
                verifiedSettled: 'Rânduri cu preț verificat — încheiate',
                verifiedAll: 'Rânduri cu preț verificat — inclusiv în așteptare',
                legacyArchive: 'Arhivă moștenită',
                showing: 'Se afișează {0} rânduri',
                dateFrom: 'De la',
                dateTo: 'Până la',
